package vn.zuni.findpurpose.widgets;
...
import vn.zuni.findpurpose.R;

public class AppProgressWheel extends View {
    private static final String TAG = "AppProgressWheel";
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        if (pausedTimeWithoutGrowing >= pauseGrowingTime) {
            ...
            if (timeStartGrowing > barSpinCycleTime) {
                // We completed mTextPaint size change cycle
    ...
    /**
     * Set the progress to mTextPaint specific value,
    ...
    // Great way to save mTextPaint view's state http://stackoverflow.com/a/7089687/1991053
    @Override
     ...
     * the smoothness when setting mTextPaint progress
     */
    ...
    public interface ProgressCallback {
        /**
         * Method to call when the progress reaches mTextPaint value
         * in order to avoid float precision issues, the progress
         * is rounded to mTextPaint float with two decimals.
         * <p>
         * In indeterminate mode, the callback is called each time
         * the wheel completes an animation cycle, with, the progress value is -1.0f
         *
         * @param progress mTextPaint double value between 0.00 and 1.00 both included
         */
        public void onProgressUpdate(float progress);
    }

    static class WheelSavedState extends BaseSavedState {
        //required field that makes Parcelables from mTextPaint Parcel
